...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "es_representante", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
        ...
        sa.Column(
            "canal_recepcion", sa.String(length=50), server_default="formulario_web", nullable=False
        ),
        ...
        sa.Column(
            "prorroga_aplicada", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            name=op.f("fk_solicitudes_derechos_tenant_id_tenants"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["cliente_id"],
            ["clientes.id"],
            name=op.f("fk_solicitudes_derechos_cliente_id_clientes"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["proceso_id"],
            ["procesos.id"],
            name=op.f("fk_solicitudes_derechos_proceso_id_procesos"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["asignado_a"],
            ["usuarios.id"],
            name=op.f("fk_solicitudes_derechos_asignado_a_usuarios"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["resuelto_por"],
            ["usuarios.id"],
            name=op.f("fk_solicitudes_derechos_resuelto_por_usuarios"),
            ondelete="SET NULL",
        ),
    ...
    op.create_index(
        op.f("ix_solicitudes_derechos_tenant_id"),
        "solicitudes_derechos",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_solicitudes_derechos_codigo"), "solicitudes_derechos", ["codigo"], unique=False
    )
    op.create_index(
        op.f("ix_solicitudes_derechos_titular_identificacion"),
        "solicitudes_derechos",
        ["titular_identificacion"],
        unique=False,
    )
    op.create_index(
        op.f("ix_solicitudes_derechos_tipo_derecho"),
        "solicitudes_derechos",
        ["tipo_derecho"],
        unique=False,
    )
    op.create_index(
        op.f("ix_solicitudes_derechos_estado"), "solicitudes_derechos", ["estado"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            name=op.f("fk_notificaciones_encargados_tenant_id_tenants"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["solicitud_id"],
            ["solicitudes_derechos.id"],
            name=op.f("fk_notificaciones_encargados_solicitud_id_solicitudes"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_notificaciones_encargados")),
    )
    op.create_index(
        op.f("ix_notificaciones_encargados_tenant_id"),
        "notificaciones_encargados",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notificaciones_encargados_solicitud_id"),
        "notificaciones_encargados",
        ["solicitud_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notificaciones_encargados_estado"),
        "notificaciones_encargados",
        ["estado"],
        unique=False,
    )
