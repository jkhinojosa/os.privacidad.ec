...
def upgrade() -> None:
    ...
    op.add_column(
        "procesos",
        sa.Column("colectivos_titulares", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    )
    op.add_column(
        "procesos",
        sa.Column("tiene_perfiles", sa.Boolean(), server_default=sa.text("false"), nullable=False),
    )
    op.add_column(
        "procesos",
        sa.Column(
    ...
    op.add_column(
        "procesos",
        sa.Column("paises_transferencia", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    )
    op.add_column(
        "procesos", sa.Column("garantias_transferencia", sa.String(length=255), nullable=True)
    )
    ...
    op.add_column(
        "procesos",
        sa.Column(
            "permanencia_tratamiento",
            sa.String(length=50),
            server_default="indefinida",
            nullable=False,
        ),
    )
    op.add_column("procesos", sa.Column("volumen_titulares_estimado", sa.Integer(), nullable=True))
    op.add_column(
        "procesos", sa.Column("puntaje_mtge", sa.Float(), server_default="0.0", nullable=False)
    )
    op.add_column(
        "procesos",
        sa.Column("requiere_eipd", sa.Boolean(), server_default=sa.text("false"), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            name=op.f("fk_medidas_seguridad_tenant_id_tenants"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_medidas_seguridad_tenant_id"), "medidas_seguridad", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_medidas_seguridad_codigo"), "medidas_seguridad", ["codigo"], unique=False
    )
    op.create_index(op.f("ix_medidas_seguridad_tipo"), "medidas_seguridad", ["tipo"], unique=False)
    op.create_index(
        op.f("ix_medidas_seguridad_estado_implementacion"),
        "medidas_seguridad",
        ["estado_implementacion"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "es_grupo_vulnerable", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
        ...
        sa.Column(
            "nivel_riesgo_inherente", sa.String(length=50), server_default="medio", nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            name=op.f("fk_riesgos_tenant_id_tenants"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["proceso_id"],
            ["procesos.id"],
            name=op.f("fk_riesgos_proceso_id_procesos"),
            ondelete="SET NULL",
        ),
    ...
    op.create_index(
        op.f("ix_riesgos_nivel_riesgo_inherente"),
        "riesgos",
        ["nivel_riesgo_inherente"],
        unique=False,
    )
    op.create_index(
        op.f("ix_riesgos_nivel_riesgo_residual"), "riesgos", ["nivel_riesgo_residual"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            name=op.f("fk_riesgo_medidas_tenant_id_tenants"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["riesgo_id"],
            ["riesgos.id"],
            name=op.f("fk_riesgo_medidas_riesgo_id_riesgos"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["medida_id"],
            ["medidas_seguridad.id"],
            name=op.f("fk_riesgo_medidas_medida_id_medidas"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_riesgo_medidas_tenant_id"), "riesgo_medidas", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_riesgo_medidas_riesgo_id"), "riesgo_medidas", ["riesgo_id"], unique=False
    )
    op.create_index(
        op.f("ix_riesgo_medidas_medida_id"), "riesgo_medidas", ["medida_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            name=op.f("fk_evaluaciones_impacto_tenant_id_tenants"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["proceso_id"],
            ["procesos.id"],
            name=op.f("fk_evaluaciones_impacto_proceso_id_procesos"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["aprobado_por"],
            ["usuarios.id"],
            name=op.f("fk_evaluaciones_impacto_aprobado_por_usuarios"),
            ondelete="SET NULL",
        ),
    ...
    op.create_index(
        op.f("ix_evaluaciones_impacto_tenant_id"),
        "evaluaciones_impacto",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_evaluaciones_impacto_codigo"), "evaluaciones_impacto", ["codigo"], unique=False
    )
    op.create_index(
        op.f("ix_evaluaciones_impacto_proceso_id"),
        "evaluaciones_impacto",
        ["proceso_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_evaluaciones_impacto_estado"), "evaluaciones_impacto", ["estado"], unique=False
    )
